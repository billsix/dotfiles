...
* TODO [#1] Model View Projection
    ...
    - [ ] Switch all instructions to use spyder as ide
    - [ ] refactor framerate code to variable - this will make formatting better
    - [ ] Ch 01
      - [ ] Fix proportions of monitors
      - [ ] Fix doc regions line 23, line 27, line 32
      - [ ] Line 51, mention no idea what None, Noe means, mention looking up API vs keyword arguments
      - [ ] doubler, print out it's values
    - [ ] Ch 02
